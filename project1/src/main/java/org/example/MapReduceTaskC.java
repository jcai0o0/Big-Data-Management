...
public class MapReduceTaskC {
    ...
    public static class CitizensReducer
    ...
    public static class CitizensCombiner
            extends Reducer<Text,IntWritable,Text,IntWritable> {
        private IntWritable result = new IntWritable();
    ...
    public void debug(String[] args) throws Exception {
        ...
        job.setJarByClass(MapReduceTaskC.class);
        job.setMapperClass(CitizensMapper.class);
        job.setReducerClass(CitizensReducer.class);
        //job.setCombinerClass(CitizensCombiner.class);
